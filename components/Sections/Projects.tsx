...
function Projects() {
  ...
  return (
      <section id="about" className="flex flex-col py-10 px-[20px] lg:px-60 items-center justify-center lg:flex-col lg:items-center lg:justify-center lg:py-16">
                  ...
                  <div onClick={() => {
                      ...
                      <div className='flex flex-col gap-2 lg:gap-8'>
                          <div className='flex flex-col gap-2 lg:gap-8'>
                              ...
                              <div className='flex flex-col gap-2 lg:gap-8 lg:px-10 px-3'>
                                  <h1 className="lg:text-center text-[16px] md:text-start lg:text-[20px] md:text-[20px] font-bold">{project.title}</h1>
                                  <p className="lg:text-center md:text-start text-[14px] md:text-[16px] break-words whitespace-normal">{project.description}</p>
                              </div>
